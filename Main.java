...
import Class.Produk;
import Class.ProdukElektronik;
import Class.ProdukPakaian;
...
public class Main {
    public static void main(String[] args) {
        ...
        inventaris.tambahProduk(new ProdukElektronik(1, "Laptop Ideapad Slim 5 Pro", 9500000, 3, 12));
        inventaris.tambahProduk(new ProdukElektronik(2, "Keyboard DA Meca 6X Plus ", 500000, 10, 0));
        inventaris.tambahProduk(new ProdukElektronik(3, "Monitor Lenovo G34w-30 WQHD", 6000000, 2, 12));
        inventaris.tambahProduk(new ProdukPakaian(4, "T Shirt Oversize Polos Hitam L", 79999, 50, "L"));
        inventaris.tambahProduk(new ProdukPakaian(5, "T Shirt Oversize Polos Hitam XL", 79999, 50, "XL"));
